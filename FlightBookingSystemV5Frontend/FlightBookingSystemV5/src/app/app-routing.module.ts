...
import { CancelbookingComponent } from './MyComponents/cancelbooking/cancelbooking.component';
...
const routes: Routes = [
  ...
  { path: 'mybookings', component: CancelbookingComponent, canActivate:[AuthGuard1] },
