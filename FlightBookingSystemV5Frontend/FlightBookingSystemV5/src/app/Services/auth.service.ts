...
export class AuthService {
  ...
  getAllBookingsForUser(userIdObj:any){
    return this.http.post<any[]>(`${this.baseUrl}Booking/Bookings`, userIdObj);
  }
  ...
  paymentAPI(costObj:any){
    return this.http.post<any>(`${this.baseUrl}Payment`, costObj);
  }
  ...
  getUserIdFromToken(){
    if(this.userPayload){
      return this.userPayload["http://schemas.xmlsoap.org/ws/2005/05/identity/claims/country"];
    }
  }
